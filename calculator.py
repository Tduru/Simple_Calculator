...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#c3d9db',font=('Arial Bold', 28), textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='#34e4f7', command=lambda:self.solve()).place(x=270 ,y=350)
